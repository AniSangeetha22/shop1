...
//   const [saleprice, setSaleprice] = useState(props.itemdata.saleprice)
    ...
    const increasequantity = async () => {
        // setSaleprice((mrp - extraforfun * mrp) * prodquantity)
        ...
        await updateDoc(itemref, {
            ...
            saleprice:(mrp - extraforfun * mrp) * (prodquantity + 1)
    ...
    const addtoordercart = () => {
        if (loggeduser) {
            ...
            addDoc(collection(db, `order-${loggeduser[0].uid}`), {
             props, saleprice: saleprice
            }).then(() => {
...
// console.log(t);
    ...
    return (
       ...
       {/* <button onClick={addtoordercart}> Order</button> */}
